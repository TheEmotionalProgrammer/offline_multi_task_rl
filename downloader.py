...
def download_dataset(
    ...
    links = [link.replace(".xz", "") for link in links]
    print(links)
...
def _unpack_category_file(
    ...
    with open(file_path, 'rb') as f:
        ...
        # Write the decompressed data to a .tar file
        tar_file_path = os.path.join(download_folder, 'temp.tar')
    ...
    # shutil.unpack_archive(file_path.replace(".xz", ""), download_folder)
    if clear_archive:
        os.remove(file_path)
