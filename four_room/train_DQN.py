...
policy_kwargs = dict(features_extractor_class=CNN, features_extractor_kwargs={'features_dim': 512},
                     normalize_images=False, net_arch=[])

callback = EvalCallback(eval_env, n_eval_episodes=num_train_configs, eval_freq=max(10000 // n_envs, 1), verbose=1)
